...
float4 SFXCelerityPS(PS_INPUT input) : COLOR0
{

	const int numSamples = 20;
	const float density  = 0.1 * amount;
	...
	float positionWeight = length(deltaTexCoord) * 2;
...
technique SFXCelerity
{
    pass p0
    {
        ...
        ZWriteEnable        = False;
        VertexShader        = compile vs_2_0 SFXBasicVS();
        PixelShader         = compile ps_2_0 SFXCelerityPS();
        CullMode            = None;
    }
}