...
function BuildTechData()
    ...
    local techData = { 
        ...
        { [kTechDataId] = kTechId.Grow,                  [kTechDataDisplayName] = "GROW" },
        ...
        { [kTechDataId] = kTechId.DetonationTimeTech,      [kTechDataCostKey] = kDetonationTimeTechResearchCost,     [kTechDataResearchTimeKey] = kDetonationTimeTechResearchTime, [kTechDataDisplayName] = "DETONATION_TIME_DECREASE", [kTechDataTooltipInfo] =  "DETONATION_TIME_DECREASE_TOOLTIP"},
        ...
        { [kTechDataId] = kTechId.Spores,   [kTechDataDisplayName] = "SPORES",  [kTechDataMapName] = Spores.kMapName, [kTechDataCostKey] = kSporesResearchCost, [kTechDataResearchTimeKey] = kSporesResearchTime, [kTechDataTooltipInfo] = "SPORES_TOOLTIP"},
        { [kTechDataId] = kTechId.Blink,         [kTechDataDisplayName] = "BLINK",  [kTechDataTooltipInfo] = "BLINK_TOOLTIP"},  
        { [kTechDataId] = kTechId.ShadowStep,   [kTechDataCostKey] = kShadowStepResearchCost, [kTechDataResearchTimeKey] = kShadowStepResearchTime,      [kTechDataDisplayName] = "SHADOWSTEP",  [kTechDataTooltipInfo] = "SHADOWSTEP_TOOLTIP"},  
        ...
        { [kTechDataId] = kTechId.BoneShield,   [kTechDataMapName] = BoneShield.kMapName,      [kTechDataDisplayName] = "BONESHIELD", [kTechDataCostKey] = kBoneShieldResearchCost, [kTechDataResearchTimeKey] = kBoneShieldResearchTime, [kTechDataTooltipInfo] = "BONESHIELD_TOOLTIP" }, 
        ...
        { [kTechDataId] = kTechId.SpikesAccuracy, [kTechDataCostKey] = kSpikesResearchCost, [kTechDataResearchTimeKey] = kSpikesResearchTime, [kTechDataDisplayName] = "SPIKES_ACCURACY", [kTechDataDamageType] = kSpikeDamageType, [kTechDataTooltipInfo] = "SPIKES_ACCURACY_TOOLTIP"},
        ...
        { [kTechDataId] = kTechId.SelectDrifter, [kTechDataDisplayName] = "SELECT_DRIFTER", [kTechDataTooltipInfo] = "SELECT_NEAREST_DRIFTER" },   
        { [kTechDataId] = kTechId.SelectShift, [kTechDataDisplayName] = "SELECT_SHIFT", [kTechDataTooltipInfo] = "SELECT_NEAREST_SHIFT" },   
        ...
        { [kTechDataId] = kTechId.TeleportHydra,  [kTechDataGhostModelClass] = "TeleportAlienGhostModel",   [kTechDataDisplayName] = "ECHO_HYDRA",  [kTechDataCostKey] = kEchoHydraCost,   [kTechDataRequiresInfestation] = true, [kTechDataModel] = Hydra.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP"},
        { [kTechDataId] = kTechId.TeleportWhip,  [kTechDataGhostModelClass] = "TeleportAlienGhostModel",   [kTechDataDisplayName] = "ECHO_WHIP",  [kTechDataCostKey] = kEchoWhipCost,   [kTechDataRequiresInfestation] = true, [kTechDataModel] = Whip.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP"},
        { [kTechDataId] = kTechId.TeleportTunnel,  [kTechDataGhostModelClass] = "TeleportAlienGhostModel",   [kTechDataDisplayName] = "ECHO_TUNNEL",  [kTechDataCostKey] = kEchoTunnelCost,   [kTechDataRequiresInfestation] = true, [kTechDataModel] = TunnelEntrance.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP"},
        { [kTechDataId] = kTechId.TeleportCrag, [kTechDataGhostModelClass] = "TeleportAlienGhostModel",   [kTechDataDisplayName] = "ECHO_CRAG",  [kTechDataCostKey] = kEchoCragCost,   [kTechDataRequiresInfestation] = true, [kTechDataModel] = Crag.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP"},
        { [kTechDataId] = kTechId.TeleportShade,  [kTechDataGhostModelClass] = "TeleportAlienGhostModel",   [kTechDataDisplayName] = "ECHO_SHADE",  [kTechDataCostKey] = kEchoShadeCost,   [kTechDataRequiresInfestation] = true, [kTechDataModel] = Shade.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP"},
        { [kTechDataId] = kTechId.TeleportShift, [kTechDataGhostModelClass] = "TeleportAlienGhostModel",   [kTechDataDisplayName] = "ECHO_SHIFT",  [kTechDataCostKey] = kEchoShiftCost,   [kTechDataRequiresInfestation] = true, [kTechDataModel] = Shift.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP"},
        { [kTechDataId] = kTechId.TeleportVeil,  [kTechDataGhostModelClass] = "TeleportAlienGhostModel",   [kTechDataDisplayName] = "ECHO_VEIL",  [kTechDataCostKey] = kEchoVeilCost,   [kTechDataRequiresInfestation] = true, [kTechDataModel] = Veil.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP"},
        { [kTechDataId] = kTechId.TeleportSpur, [kTechDataGhostModelClass] = "TeleportAlienGhostModel",   [kTechDataDisplayName] = "ECHO_SPUR",  [kTechDataCostKey] = kEchoSpurCost,   [kTechDataRequiresInfestation] = true, [kTechDataModel] = Spur.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP"},
        { [kTechDataId] = kTechId.TeleportShell,   [kTechDataGhostModelClass] = "TeleportAlienGhostModel",   [kTechDataDisplayName] = "ECHO_SHELL",  [kTechDataCostKey] = kEchoShellCost,   [kTechDataRequiresInfestation] = true, [kTechDataModel] = Shell.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP"},
        { [kTechDataId] = kTechId.TeleportHive,  [kTechDataImplemented] = false, [kTechDataGhostModelClass] = "TeleportAlienGhostModel",  [kTechDataDisplayName] = "ECHO_HIVE",  [kTechDataCostKey] = kEchoHiveCost,   [kTechDataRequiresInfestation] = false, [kTechDataModel] = Hive.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP", [kTechDataSpawnHeightOffset] = 2.494, [kStructureAttachClass] = "TechPoint"},
        { [kTechDataId] = kTechId.TeleportEgg,  [kTechDataGhostModelClass] = "TeleportAlienGhostModel",   [kTechDataDisplayName] = "ECHO_EGG",  [kTechDataCostKey] = kEchoEggCost,   [kTechDataRequiresInfestation] = true, [kTechDataModel] = Egg.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP"},
        { [kTechDataId] = kTechId.TeleportHarvester, [kStructureAttachClass] = "ResourcePoint", [kTechDataMaxExtents] = Vector(1, 1, 1), [kTechDataRequiresMature] = false, [kTechDataGhostModelClass] = "TeleportAlienGhostModel",   [kTechDataDisplayName] = "ECHO_HARVESTER",  [kTechDataCostKey] = kEchoHarvesterCost,   [kTechDataRequiresInfestation] = true, [kTechDataModel] = Harvester.kModelName, [kTechDataTooltipInfo] = "ECHO_TOOLTIP"},
        ...
        { [kTechDataId] = kTechId.Hallucinate,  [kTechDataCooldown] = kDrifterAbilityCooldown,   [kTechDataMapName] = HallucinationCloud.kMapName, [kTechDataDisplayName] = "HALLUCINATION_CLOUD", [kTechDataCostKey] = kHallucinationCloudCost, [kTechDataTooltipInfo] =  "HALLUCINATION_CLOUD_TOOLTIP"},
        { [kTechDataId] = kTechId.EnzymeCloud,  [kTechDataCooldown] = kEnzymeCloudCooldown,   [kTechDataMapName] = EnzymeCloud.kMapName, [kTechDataDisplayName] = "ENZYME_CLOUD", [kTechDataCostKey] = kEnzymeCloudCost, [kTechDataTooltipInfo] =  "ENZYME_CLOUD_TOOLTIP"},
