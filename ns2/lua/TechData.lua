...
function BuildTechData()
    ...
    local techData = { 
        ...
        { [kTechDataId] = kTechId.Railgun,               [kTechDataMapName] = Railgun.kMapName,                  [kTechDataDisplayName] = "RAILGUN", [kTechDataImplemented] = false,        [kTechDataDamageType] = kRailgunDamageType,         [kTechDataCostKey] = kRailgunCost, [kTechDataDisplayName] = "RAILGUN_CLAW_TOOLTIP", [kTechDataModel] = Railgun.kModelName},
        ...
        { [kTechDataId] = kTechId.GorgeTunnel, [kTechDataGhostModelClass] = "AlienGhostModel",  [kTechDataAllowConsumeDrop] = true, [kTechDataAllowStacking] = false,  [kTechDataMaxAmount] = kNumGorgeTunnels,     [kTechDataMapName] = TunnelEntrance.kMapName,    [kTechDataDisplayName] = "TUNNEL_ENTRANCE",           [kTechDataCostKey] = kGorgeTunnelCost,  [kTechDataMaxHealth] = kTunnelEntranceHealth, [kTechDataMaxArmor] = kTunnelEntranceArmor, [kTechDataBuildTime] = kGorgeTunnelBuildTime, [kTechDataModel] = TunnelEntrance.kModelName, [kTechDataRequiresInfestation] = false, [kTechDataPointValue] = kTunnelEntrancePointValue },
        { [kTechDataId] = kTechId.GorgeTunnelTech, [kTechDataDisplayName] = "GORGETUNNELTECH", [kTechDataTooltipInfo] = "GORGETUNNELTECH_TOOLTIP", [kTechDataCostKey] = kGorgeTunnelResearchCost, [kTechDataResearchTimeKey] = kGorgeTunnelResearchTime },
        ...
        { [kTechDataId] = kTechId.Babbler,   [kTechDataMaxAmount] = kNumBabblersPerGorge,     [kTechDataBuildTime] = kBabblerEggBuildTime,          [kTechDataMapName] = Babbler.kMapName,  [kTechDataDisplayName] = "BABBLER",  [kTechDataModel] = Babbler.kEggModelName, [kTechDataMaxHealth] = kBabblerHealth, [kTechDataMaxArmor] = kBabblerArmor, [kTechDataPointValue] = kBabblerPointValue, [kTechDataTooltipInfo] = "BABBLER_TOOLTIP" },
