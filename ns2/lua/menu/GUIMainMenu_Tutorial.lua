...
local function CreateTutorialPage(self)
    ...
    self.tutLink0.OnClick = function() Client.ShowWebpage("http://unknownworlds.com/spark/ns2/tutorials/tut0.html") end
    ...
    self.tutLink1.OnClick = function() Client.ShowWebpage("http://unknownworlds.com/spark/ns2/tutorials/tut1.html") end
    ...
    self.tutLink2.OnClick = function() Client.ShowWebpage("http://unknownworlds.com/spark/ns2/tutorials/tut2.html") end
    ...
    self.tutLink3.OnClick = function() Client.ShowWebpage("http://unknownworlds.com/spark/ns2/tutorials/tut3.html") end
    ...
    self.tutLink4.OnClick = function() Client.ShowWebpage("http://unknownworlds.com/spark/ns2/tutorials/tut4.html") end
    ...
    self.tutLink7.OnClick = function() Client.ShowWebpage("http://unknownworlds.com/spark/ns2/tutorials/tut7.html") end
    ...
    self.tutLink8.OnClick = function() Client.ShowWebpage("http://unknownworlds.com/spark/ns2/tutorials/tut8.html") end
    ...
    self.tutLink9.OnClick = function() Client.ShowWebpage("http://unknownworlds.com/spark/ns2/tutorials/tut9.html") end
    ...
    self.tutLink10.OnClick = function() Client.ShowWebpage("http://unknownworlds.com/spark/ns2/tutorials/tut10.html") end
    ...
    self.tutLink11.OnClick = function() Client.ShowWebpage("http://unknownworlds.com/spark/ns2/tutorials/tut11.html") end
